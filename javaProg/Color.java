/**
 * 
 * @author Alex This Class is responsible all operations with colors Maybe it
 *         would be better to do colors with strings in another class And then
 *         make Color chooser
 */
public final class Color {
	public final static String[] RESISTOR_BAND_COLORS = { "black", "brown", "red", "orange", "yellow", "green", "blue",
	...
	public static String[] baseColors() {
	...
	public static String[] baseAndNoneColors() {
		String[] myColors = new String[11];
		int index = 0;
		for (String i : Color.RESISTOR_BAND_COLORS) {
			if (index < 10) {
				myColors[index] = new String(i);
	...
	public static String[] toleranceColors() {
		...
		for (String i : Color.RESISTOR_BAND_COLORS) {
			int colorInt = Color.colorToInt(i);
			if (colorInt == 1 || colorInt == 2 || colorInt == 5 || colorInt == 6 || colorInt == 7 || colorInt == 8
